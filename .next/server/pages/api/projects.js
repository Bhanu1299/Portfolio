    ...
    switch(req.method){
        case "GET":
            try {
                ...
                const projects = await _models__WEBPACK_IMPORTED_MODULE_1__/* .Project.find */ .IK.find(query).sort({
                    featured: -1,
                    order: 1,
                    createdAt: -1
                }).lean();
        ...
        case "POST":
            try {
                const project = await _models__WEBPACK_IMPORTED_MODULE_1__/* .Project.create */ .IK.create(req.body);
                res.status(201).json({
                    success: true,
                    data: project
                });
...
var __webpack_exports__ = __webpack_require__.X(0, [241,903], () => (__webpack_exec__(706)));
